...
def main():
    results_folder = f"{os.getcwd()}/lighting_training_logs" # Where to save test results
    base_hdf5_path = "O:/Tech_NTLab/DataSets/testData/sleep_data_set/csdp_demo/hdf5" # Base-path to the HDF5 files. Should contain at least one HDF5 file
    ...
    pretrained_path = "usleep_checkpoints/lightning/two_channel/alternative_big_sleep.ckpt"
    ...
    train_sampler = Random_Sampler(split, num_epochs=sleep_epochs_per_sample, num_iterations=training_iterations)
    ...
    if pretrained_path == None:
        net: USleep_Lightning = USleep_Lightning(lr=learning_rate, 
    ...
    net.run_test(trainer, test_loader, output_folder_prefix=results_folder)
