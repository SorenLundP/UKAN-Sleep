...
def train_student_model(student_model, data_loader, device, optimizer, scheduler, num_epochs=30000000):
    ...
    log_file = open('UKAN_no_teacher_model__training_log.txt', 'w')
        ...
        if epoch % 2 == 0:  # Validate every 2 epochs
            ...
            with torch.no_grad():
                ...
                if acc > best_val_acc:
                    best_val_acc = acc
                    no_improvement_epochs = 0
                    torch.save(student_model.state_dict(), "UKAN_no_teacher_model.pth")
...
def save_plots():
    ...
    output_path = "/users/srenlund/_UKAN_no_teacher_model_training_metrics.pkl"
...
def main():
    ...
    student_weights_path = "/users/srenlund/UKAN_no_teacher_model.pth"
    ...
    torch.save(student_model.state_dict(), "final_UKAN_no_teacher_model.pth")
