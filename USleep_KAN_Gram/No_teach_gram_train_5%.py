...
def train_student_model(student_model, data_loader, device, optimizer, scheduler, num_epochs=30000000):
    ...
    log_file = open('UKAN_no_teacher_model_5%_training_log.txt', 'w')
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 2 == 0:  # Validate every 2 epochs
            ...
            with torch.no_grad():
                ...
                if acc > best_val_acc:
                    best_val_acc = acc
                    no_improvement_epochs = 0
                    torch.save(student_model.state_dict(), "UKAN_no_teacher_model_5%.pth")
        ...
        with open('UKAN_no_teacher_model_5%_training_log.txt', 'a') as log_file:
...
def save_plots():
    ...
    output_path = "./UKAN_no_teacher_model_5%_training_metrics.pkl"
    with open(output_path, 'wb') as f:
        pickle.dump(metrics, f)
        pickle.dump(fig, f)
    fig.savefig("training_metrics_plot_UKAN_no_teacher_model_5%.png")
...
def main():
    ...
    student_weights_path = "./UKAN_no_teacher_model_5%.pth"
    ...
    torch.save(student_model.state_dict(), "final_UKAN_no_teacher_model_5%.pth")
    ...
    with open('training_metrics_lists_UKAN_no_teacher_model_5%.pkl', 'wb') as f:
        pickle.dump(metrics, f)
